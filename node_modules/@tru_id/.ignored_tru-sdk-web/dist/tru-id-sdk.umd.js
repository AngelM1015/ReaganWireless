(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.tru = global.tru || {}, global.tru.ID = {})));
}(this, (function (exports) { 'use strict';

  const DeviceCoverageErrors = {
    UnsupportedMNO: 400,
    NotMobileIP: 412,
  };
   ...
   */
  async function getReachability(apiBaseUrl) {
    if (!apiBaseUrl) {
  ...
  exports.DeviceCoverageErrors = DeviceCoverageErrors;
  exports._createIFrameSrc = _createIFrameSrc;
  exports.default = index;
  exports.getReachability = getReachability;
  exports.openCheckUrl = openCheckUrl;
